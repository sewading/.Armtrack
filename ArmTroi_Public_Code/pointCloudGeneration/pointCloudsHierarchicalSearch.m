function [pointCloudFirst,pointCloudSecond,pointCloudFirstBoundary] = pointCloudsHierarchicalSearch(pointCloud,m,n,origin,r)
% ***************functionality***************:
...
for i = 1:120219 % 120219 is based on the generated original point clouds
    key = keys{i};
