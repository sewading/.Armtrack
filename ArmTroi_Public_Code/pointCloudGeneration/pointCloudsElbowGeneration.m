function [pointCloud] = pointCloudsElbowGeneration(ltrunk,la1,la2,la3)
% ***************functionality***************:
...
rotWatchLabel = zeros(3,2,23198292); % 23198292 is calculated based on the granularity in advance
factor = pi/30;
tolZ = factor;
tolX = factor;
tolY = factor;
